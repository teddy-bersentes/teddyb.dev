	...
	return (
		<svg className='absolute top-0 -left-10' width="68" height="78" viewBox="0 0 68 78" fill="none" xmlns="http://www.w3.org/2000/svg">
			<motion.path
				initial={{ scale: 1 }}
				animate={{ scale: [0.8, 1] }}
				transition={{ duration: 1, ...infiniteTransition, delay: 1, repeatDelay: 0.15 }}
			...
			<motion.path
				...
				animate={{ scale: [0.7, 1], rotate: [0, -15] }}
				transition={{ duration: 1.75, ...infiniteTransition, delay: 1.25 }}
			...
			<motion.path
				initial={{ scale: 1, rotate: 0 }}
				animate={{ scale: [0.8, 1], rotate: [0, 20] }}
				transition={{ duration: 1.25, ...infiniteTransition }}
