...
import SingleImageScaleView from "~/components/SingleImageScaleView";

<SingleImageScaleView
	url="https://ucarecdn.com/0f7dd8d6-ed00-47ec-b496-65a21d1a6dba/dashboardshadow.png"
	alt="An image of the home screen"
	blurHash="U7Q0aRIt-;~p=^-n?aIp9Et6xujbb{D+Rj-o"
/>
...
<div className="flex flex-col justify-center items-center p-2.5 bg-white border border-[#EBEBEB] rounded-3xl">
	![A video of the site map](/images/projects/sitecomms/site-map-feature.gif)
</div>
...
<div className="flex flex-col justify-center items-center p-2.5 bg-white border border-[#EBEBEB] rounded-3xl px-6">
	![Our take on a site
	induction](https://ucarecdn.com/b0d06238-e046-4324-bc7a-77690fc2d4da/phonesmaps.png)
</div>
...
![An image of the peronnel page with some scanning screens](https://ucarecdn.com/1e50e59b-52c8-4c9e-a4fb-6fc966117afb/qrstuff.png)
...
<SingleImageScaleView
	url="https://ucarecdn.com/45af5908-e8a3-4b3e-9b2c-beec07151275/hazards.png"
	alt="An image of the site management screen"
	blurHash="UKR3TW%M~qx[RPWBxuof?vRjIAof.8ofV@WB"
/>
...
export default ({ children }) => (
	<Article
		title="Site Comms"
		description="Lead Developer • Full stack development"
